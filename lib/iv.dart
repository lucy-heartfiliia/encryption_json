...
//     : _bytes = EncryptionUtils.decodeHexString(encoded);
...
//   Encrypted.fromLength(int length) : _bytes = SecureRandomE(length).bytes;

//   /// Creates an Encrypted object from a length.
//   /// The key is filled with [length] bytes generated by a
//   /// Random.secure() generator
//   Encrypted.fromSecureRandomE(int length)
//     : _bytes = SecureRandomE(length).bytes;
...
//   /// The key is filled with [length] bytes generated by a
//   /// Random.secure() generator
//   IV.fromSecureRandomE(int length) : super(SecureRandomE(length).bytes);
...
//   /// The key is filled with [length] bytes generated by a
//   /// Random.secure() generator
//   Key.fromSecureRandomE(int length) : super(SecureRandomE(length).bytes);
...
//   }) {
//     if (salt == null) {
//       salt = SecureRandomE(desiredKeyLength).bytes;
//     }
