...
//   external factory SecurityPlayer(String id, [js.JSObject? options]);

//   // Add this factory constructor
//   external factory SecurityPlayer.fromJSObject(js.JSAny jsObject);
// }
...
// // Options types
// extension type SecurityOptions._(js.JSObject _) implements js.JSObject {
...
// extension type SecurityVars._(js.JSObject _) implements js.JSObject {
...
// extension type SecurityKernelEvents._(js.JSObject _) implements js.JSObject {
...
// @js.JS('onYouTubeIframeAPIReady')
// external set onYouTubeIframeAPIReady(js.JSFunction callback);

// @js.JS()
// external js.JSAny get yT;
...
// @js.JS()
// external js.JSFunction get jsOnPlayerReady;

// @js.JS()
// external set jsOnPlayerReady(js.JSFunction fn);
